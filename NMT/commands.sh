...
python3 main.py --exp_name config_train_100_0 --exp_id results --dump_path /home/abhinavds/Documents/Projects/NLP/nmt --transformer True --n_enc_layers 4 --n_dec_layers 4 --share_enc 3 --share_dec 3 --share_lang_emb False --share_output_emb False --langs 'x,y' --n_mono -1  --mono_dataset 'x:/home/abhinavds/Documents/Projects/NLP/nmt/config_train_100_0/data/para.x.pth,,;y:/home/abhinavds/Documents/Projects/NLP/nmt/config_train_100_0/data/para.y.pth,,' --n_para -1 --para_dataset 'x-y:/home/abhinavds/Documents/Projects/NLP/nmt/config_train_100_0/data/para.XX.pth,/home/abhinavds/Documents/Projects/NLP/nmt/config_train_100_0/data/conala-dev.XX.pth,/home/abhinavds/Documents/Projects/NLP/nmt/config_train_100_0/data/conala-test.XX.pth' --para_directions 'x-y,y-x' --pivo_directions 'x-y-x,y-x-y'   --lambda_xe_para '0:1,100000:0.1,300000:0'  --lambda_xe_otfd 1 --lambda_dis 0.5 --n_dis 2 --otf_num_processes 30 --otf_sync_params_every 1000 --enc_optimizer adam,lr=0.0001 --epoch_size -1 --stopping_criterion bleu_x_y_valid,10 --cudnn_enabled False


python3 preprocess.py --data-dir ../../conala-clean/ --out-dir ../../nmt/ --name config_train_100_0 --file-info "conala-trainnodev,100,0" --dev conala-dev --test conala-test