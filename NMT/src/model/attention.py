...
def build_attention_model(params, data, cuda=True):
	...
	if cuda:
		...
		# reload encoder / decoder / discriminator / seq_discriminator
		if params.reload_model != '':
			...
			if params.reload_seq_dis:
				...
				logger.info("Reloading seq_discriminator...")
				seq_dis = reloaded.get('seq_dis', reloaded.get('seq_discriminator'))
